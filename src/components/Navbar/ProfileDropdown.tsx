...
const ProfileDropdown: FC<unknown> = () => {
  ...
  return (
    <div className="relative flex items-center justify-center w-10">
      <Popover className="relative hidden text-black lg:flex">
        <Popover.Button>
          <img className="h-10 rounded-full" src={makeBlockie(state.address)} />
        </Popover.Button>
      ...
      <img
        className="flex rounded-full h-10 text-white lg:hidden"
        src={makeBlockie(state.address)}
